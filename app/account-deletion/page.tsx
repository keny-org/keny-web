    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 py-32 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl font-black tracking-tight mb-12">
            Account Deletion
          </h1>

          <div className="prose prose-zinc dark:prose-invert max-w-none text-muted-foreground leading-relaxed space-y-12">
            <p className="text-lg">
              If you wish to delete your KENY account, you can do so directly
            ...
            <div className="p-8 bg-destructive/10 border border-destructive/20">
              <p className="text-destructive font-bold text-lg">
                This action is irreversible. Once deleted, you will not be able
            ...
            <p className="text-sm">
              Account deletion is processed immediately, but it may take up to
              30 days for all data to be completely removed from our backups.
            </p>
